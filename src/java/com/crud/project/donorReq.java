 ...
 * @author Aarya
 */
public class donorReq extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet donorReq</title>");   
            ...
            try{
                out.println("in");
                DonorDao udao=new DonorDao(ConnectionDao.getCon());
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet donorReq at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
